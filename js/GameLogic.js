    ...
    layerDefinitions.forEach((layerDef, layerIndex) => {
        for (let row = 0; row < layerDef.rows; row++) {
            for (let col = 0; col < layerDef.cols; col++) {
                ...
                let tile = game.deck[deckcount];
                deckcount++;
                var geometryCube = new THREE.BoxGeometry(tileWidth1, tileHeight1, tileDepth1);
                var cubeTexture = new THREE.ImageUtils.loadTexture('texture/tiles/' + tile + '.png');
                var materialCube = [
                ...
                offsetX = ((col - (layerDef.cols / 2)) + 0.5) * (tileWidth1 + gap);
                offsetY = layerHeight * (layerIndex - 5); // Stack layers on top of each other
                offsetZ = ((row - (layerDef.rows / 2)) + 0.5) * (tileDepth1 + gap);
                ...
                for (let row = 0; row < layerDef.rows; row++) {
                    for (let col = 0; col < layerDef.cols; col++) {
                        ...
                        if (layerIndex === 2 || layerIndex === 5) {
                            offsetX = ((col - (layerDef.cols / 2)) - 4) * (tileWidth1 + gap);
                        } else if (layerIndex === 3 || layerIndex === 4) {
                            offsetX = ((col - (layerDef.cols / 2)) - 4.5 ) * (tileWidth1 + gap);
                        } else if (layerIndex === 6 || layerIndex === 9) {
                            offsetX = ((col - (layerDef.cols / 2)) + 5 ) * (tileWidth1 + gap);

                        } else if (layerIndex === 7 || layerIndex === 8) {
                            offsetX = ((col - (layerDef.cols / 2)) + 5.5 ) * (tileWidth1 + gap);
                        } else if (layerIndex === 10 ) {
                            offsetX = ((col - (layerDef.cols / 2)) - 6) * (tileWidth1 + gap);
                        } else if (layerIndex === 11 ) {
                            offsetX = ((col - (layerDef.cols / 2)) + 7.5 ) * (tileWidth1 + gap);

                        } else {
                            offsetX = ((col - (layerDef.cols / 2)) + 0.5) * (tileWidth1 + gap);
                        }
                        if (layerIndex === 0) {
                            offsetZ = ((row - (layerDef.rows / 2)) + 4) * (tileDepth1 + gap);
                        } else if (layerIndex === 1) {
                            offsetZ = ((row - (layerDef.rows / 2)) - 3) * (tileDepth1 + gap);
                        } else if (layerIndex === 2 || layerIndex === 6) {
                            offsetZ = ((row - (layerDef.rows / 2)) - 1) * (tileDepth1 + gap);
                        } else if (layerIndex === 3 || layerIndex === 7) {
                            offsetZ = ((row - (layerDef.rows / 2))  ) * (tileDepth1 + gap);
                        } else if (layerIndex === 4 || layerIndex === 8) {
                            offsetZ = ((row - (layerDef.rows / 2)) + 1) * (tileDepth1 + gap);
                        } else if (layerIndex === 5 || layerIndex === 9) {
                            offsetZ = ((row - (layerDef.rows / 2)) + 2) * (tileDepth1 + gap);
